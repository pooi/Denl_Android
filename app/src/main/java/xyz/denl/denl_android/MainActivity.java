...
//                    filePathCallbackLollipop.onReceiveValue(null);
        ...
        mWebView.addJavascriptInterface(new JavaScriptInterface(handler), "Denl");

        mWebView.loadUrl("https://beta.denl.xyz");
            ...
            switch (msg.what)
            {
                ...
                case MSG_CHANGE_STATUSBAR_COLOR_ORANGE:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        ...
                        float green = 175.0f/255.0f;
                        float blue = 28.0f/255.0f;
